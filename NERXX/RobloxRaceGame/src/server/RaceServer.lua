...
-- Vehicle System
local function createVehicle(player, vehicleType)
    ...
    -- Erstelle Vehicles Ordner falls nicht vorhanden
    ...
    body.BrickColor = BrickColor.new(vehicleConfig.Color)
